...
/**
 * ProjectsSupervisors Component
 *
 * This component displays a table of projects supervised by the logged-in user (supervisor).
 * 
 * Features:
 * - Fetches and filters projects based on the supervisor's email.
 * - Displays project details such as code, title, students, Git link, notes, and deadlines.
 * - Allows searching and filtering projects by Part A, Part B, or All.
 * - Clicking a project opens a detailed popup with additional options.
 */
...
const ProjectsSupervisors = () => {
  ...
  const projectColumns = useMemo(
    () => [
      ...
      },
      {
        ...
        render: (deadline) =>
          deadline
            ? new Date(deadline._seconds * 1000).toLocaleDateString()
            : "N/A",
      },
    ],
    []
  ...
  if (isLoading) {
    return (
      <LoadingScreen
        isLoading={isLoading}
        description="Fetching your supervised projects..."
      />
    );
  }
