...
/**
 * This component renders the admin forms management page.
 * It allows administrators to view and manage forms in the system.
 * 
 * The component includes tabs for switching between "User Management" and "Forms Management".
 * It fetches the forms from the API and displays them in a table.
 */
const AdminForms = () => {
  ...
  /**
   * Navigates to the admin edit form page.
